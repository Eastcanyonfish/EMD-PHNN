...
To utilize the PHNN model:
    ...
    Run EMD.py to decompose prices.
    Use datapreproc.py to reshape components.
    Choose a sub-network architecture from PHNNmodel.
    Evaluate model performance with Evaluation.py.
    Refer to Demo.py for an example implementation.
